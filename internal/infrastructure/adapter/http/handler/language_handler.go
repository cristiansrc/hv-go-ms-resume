...
func (h *LanguageHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.useCase.Update(r.Context(), id, &req); err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to update language")
		return
	}
...
func (h *LanguageHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.useCase.Delete(r.Context(), id); err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to delete language")
		return
	}
	w.WriteHeader(http.StatusNoContent)
}
