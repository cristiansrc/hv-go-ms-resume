...
// SkillHandler handles HTTP requests for the Skill entity.
type SkillHandler struct {
	useCase input.SkillUseCase
}

// NewSkillHandler creates a new SkillHandler.
func NewSkillHandler(useCase input.SkillUseCase) *SkillHandler {
	return &SkillHandler{useCase: useCase}
}

// List handles GET /v1/ms-resume/skills
...
// GetByID handles GET /v1/ms-resume/skills/{id}
func (h *SkillHandler) GetByID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, entity.ErrNotFound) {
			WriteError(w, r, http.StatusNotFound, "NOT_FOUND", "Skill not found")
			return
		}
...
// Create handles POST /v1/ms-resume/skills
func (h *SkillHandler) Create(w http.ResponseWriter, r *http.Request) {
	var req request.SkillRequest
	if !decodeAndValidate(w, r, &req) {
		return
	}
	resp, err := h.useCase.Create(r.Context(), &req)
	if err != nil {
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to create skill")
		return
	}
	w.Header().Set("Content-Type", "application/json")
...
// Update handles PUT /v1/ms-resume/skills/{id}
func (h *SkillHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.useCase.Update(r.Context(), id, &req); err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to update skill")
		return
	}
	w.WriteHeader(http.StatusNoContent)
}

// Delete handles DELETE /v1/ms-resume/skills/{id}
func (h *SkillHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.useCase.Delete(r.Context(), id); err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to delete skill")
		return
	}
	w.WriteHeader(http.StatusNoContent)
}
