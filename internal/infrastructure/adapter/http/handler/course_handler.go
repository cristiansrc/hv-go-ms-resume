...
// CourseHandler handles HTTP requests for the Course entity.
...
// List handles GET /v1/ms-resume/courses
...
// GetByID handles GET /v1/ms-resume/courses/{id}
func (h *CourseHandler) GetByID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, entity.ErrNotFound) {
			WriteError(w, r, http.StatusNotFound, "NOT_FOUND", "Course not found")
			return
		}
...
// Create handles POST /v1/ms-resume/courses
func (h *CourseHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to create course")
		return
	}
	w.Header().Set("Content-Type", "application/json")
...
// Update handles PUT /v1/ms-resume/courses/{id}
func (h *CourseHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.useCase.Update(r.Context(), id, &req); err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to update course")
		return
	}
	w.WriteHeader(http.StatusNoContent)
}

// Delete handles DELETE /v1/ms-resume/courses/{id}
func (h *CourseHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.useCase.Delete(r.Context(), id); err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to delete course")
		return
	}
	w.WriteHeader(http.StatusNoContent)
}
